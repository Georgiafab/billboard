...
const Deposit = ({ totalUsageFee, errorCb, depositOpen, setDepositOpen }: IDeposit) => {
    ...
    return <>
        ...
        >
            ...
            <Input value={deposit} onInput={(e) => setdeposit(e.currentTarget.value)} className={`rounded  text-black !bg-[#F6F6F6] mt-8 h-12 border-0 text-xl max-md:text-lg max-md:h-8 `}
